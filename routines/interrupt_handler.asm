...
nmi:
    ...
    LDA $0041 : STA !bg3_cam_x_backup
    LDA $0042 : STA !bg3_cam_x_backup+1
    LDA $0043 : STA !bg3_cam_y_backup
    LDA $0044 : STA !bg3_cam_y_backup+1
...
.nmi_with_hud
    ...
    LDX #$80 : STX $15 ; !reg_vmain - increment after writing to $2119
    LDX #$7E : STX !reg_a1b0 ; source bank
    LDA #$6400 : STA $16 ; !reg_vmadd - VRAM destination
    ...
    LDA.b !hud_hofs : STA $11
    LDA.b !hud_hofs>>8 : STA $11
    LDA.b !hud_vofs : STA $12
    LDA.b !hud_vofs>>8 : STA $12
